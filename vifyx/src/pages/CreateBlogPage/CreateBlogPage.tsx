           ...
           {!nextStep ?  
            <div className="flex h-auto">
                <div className="w-full m-h-10 p-5 flex flex-col">
                        ...
                        <input value={title} onChange={(e) => setTitle(e.target.value)}  placeholder="Введите название" type="text" className="w-full text-sm md:text-[21px] md:mb-5 h-[38px] border-solid border-[#A0A0A0] border-[1px] rounded-md md:h-[75px] md:border-[2px] md:rounded-md md:px-12 md:pl-16 px-4 mb-2" />
                        <EditorTextArea/>
